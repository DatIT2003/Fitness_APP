...
export default function Home() {
  ...
  const { displayName } = route.params || { displayName: 'Khách' };
      ...
      try {
        ...
        if (!granted) {
          const result = await PermissionsAndroid.request(
            PermissionsAndroid.PERMISSIONS.ACTIVITY_RECOGNITION,
            {
              title: 'Quyền truy cập Pedometer',
              message: 'Ứng dụng này yêu cầu quyền truy cập để đếm bước chân của bạn.',
              buttonNegative: 'Hủy',
              buttonPositive: 'OK',
            }
          );
          ...
          if (result === PermissionsAndroid.RESULTS.GRANTED) {
            ...
            // Xử lý khi người dùng hủy yêu cầu quyền truy cập
            console.log('Yêu cầu quyền bị hủy');
          }
        } else {
          setIsPermissionGranted(true);
        }
      } catch (error) {
        console.error('Lỗi khi kiểm tra hoặc yêu cầu quyền truy cập:', error);
      }
    };
        ...
        <View style={styles.cardContainer}>
          <TouchableOpacity
            ...
            <View style={styles.cardTextContainer}>
              <Text style={styles.cardText}>Bài tập</Text>
            </View>
          </TouchableOpacity>
          ...
          <TouchableOpacity
            ...
            />
            <View style={styles.cardTextContainer}>
              <Text style={styles.cardText}>Chế độ ăn</Text>
            </View>
          </TouchableOpacity>
        </View>
      </ScrollView>
